...
```json5
{
  "extends": [
    ...
    "github>ulgens/renovate-presets:all.json5#v0.0.10",
  ],
}
```
...
```json5
{
  "extends": [
    // https://github.com/ulgens/renovate-presets
    "github>ulgens/renovate-presets:misc.json5#v0.0.10",
    "github>ulgens/renovate-presets:pre-commit.json5#v0.0.10",
    "github>ulgens/renovate-presets:python.json5#v0.0.10",
  ],
}
```
